    ...
    return (
      <div className={style.Footer}>
        <div className={style.left}>
          <img className={style.logo} src="/logoWhite.png" />
          <p className={style.title}>CALL US TODAY</p>
          <p className={style.Number}>+ 1 634 7638 654</p>
          ...
          <p className={style.desc}>Fusce eu magna quis velit efficitur rhoncus. Vivamus vehicula, neque a velit</p>
        </div>
          ...
          <div className={style.top}>
            ...
            <div className={style.third}>
              ...
              <ul className={style.dot}>
                <li onClick={listNews(0)}></li>
                <li onClick={listNews(1)}></li>
              </ul>
            </div>
