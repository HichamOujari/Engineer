...
export default class Single_Serv_Card extends Component {
  ...
  render() {
    return (
      <div className={style.Single_Serv_Card}>
          <div data-aos="fade-in" className={style.front}>
              ...
              <p className={style.desc}>Donec ut tempus massa, egestas facilisis augue. Maecenas et ante ac purus feugiat malesuada</p>
          </div>
